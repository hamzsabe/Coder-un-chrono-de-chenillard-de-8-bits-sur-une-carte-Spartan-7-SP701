...
HD_PWD='C:/Users/hamza/Desktop/Chrono/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log chenille.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source chenille.tcl -notrace
