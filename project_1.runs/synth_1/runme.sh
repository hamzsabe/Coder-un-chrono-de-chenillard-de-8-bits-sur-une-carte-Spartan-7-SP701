...
HD_PWD='C:/Users/hamza/Desktop/Chrono/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chenille.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source chenille.tcl
